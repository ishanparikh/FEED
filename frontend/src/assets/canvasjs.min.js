...
(function () {
    ...
    Aa.prototype.setLayout = function () {
        if (this.text) {
            var k = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, p = k.layoutManager.getFreeSpace(),
    ...
    Na.Chart = function () {
        ...
        p.prototype._plotAreaMouseMove = function (a, d) {
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                var b = 0, c = 0, e = b = null, e = 0 <= this.zoomType.indexOf("x"),
                    g = 0 <= this.zoomType.indexOf("y"), m = this;
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (null !== x && "" !== x) {
                    var t = na("indexLabelPlacement", h.dataPoint, h.dataSeries),
                        C = na("indexLabelOrientation", h.dataPoint, h.dataSeries), ma = h.direction,
                        y = h.dataSeries.axisX, A = h.dataSeries.axisY, v = !1, f = new ka(d, {
                            x: 0,
                            y: 0,
        ...
        p.prototype.renderLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var g = [], m, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (b.setLineDash) {
                        var n = R(h.nullDataLineDashType, h.lineThickness), q = h.lineDashType,
        ...
        p.prototype.renderArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < p.length) {
                        var z = B._colorSet[k % B._colorSet.length], aa = B.lineColor = B.options.lineColor || z,
                            T = aa;
                        g.fillStyle = z;
                        g.strokeStyle = aa;
                ...
                for (var p = !1, p = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < x.length) for (var z = 5 < k && C.bevelEnabled ? !0 : !1, m = 0; m < x.length; m++) if (x[m].getTime ? f = x[m].x.getTime() : f = x[m].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && !u(x[m].y) && x[m].y.length && "number" === typeof x[m].y[0] && "number" === typeof x[m].y[1] && "number" === typeof x[m].y[2] && "number" === typeof x[m].y[3] && "number" === typeof x[m].y[4] && 5 === x[m].y.length) {
                        ...
                        var y = l - k / 2 << 0, A = l + k / 2 << 0, e = x[m].color ? x[m].color : C._colorSet[0],
                            ...
                            Q = u(C.options.fillOpacity) ? 1 : C.fillOpacity, P = C.dataPointIds[m];
        ...
        p.prototype.renderPie = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var h =
                        this.data[a.dataSeriesIndexes[0]], s = h.dataPoints, q = 10, n = this.plotArea, f = h.dataPointEOs,
        ...
        H.prototype.render = function () {
            ...
            for (var l = 0, k = 0; k < m.length; k++) {
                for (var h = m[k], s = 0, q = 0; q < h.items.length; q++) {
                    var n = h.items[q], f = n.textBlock.x + a + (0 === q ? 0.2 * g : this.horizontalSpacing), p = d + l,
                        u = f;
        ...
        F.prototype.getDataPointAtX = function (a, d) {
            ...
            var b = {dataPoint: null, distance: Infinity, index: NaN}, c = null, e = 0, g = 0, m = 1, l = Infinity,
                k = 0, h = 0, s = 0;
